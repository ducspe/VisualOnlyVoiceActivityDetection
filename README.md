### This repository containes our implementation for the approach presented in our paper: <em>See the silence: improving visual-only voice activity detection by optical flow and RGB fusion</em>.
